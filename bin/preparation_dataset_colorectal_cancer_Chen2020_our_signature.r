...
GSE_code <- "GSE161158" # this line will change for each different dataset
thisGEOplatform <- "GPL570" # this line will change for each different dataset
datasetName <-  "Chen2020" # this line will change for each different dataset
...
LABEL_DETECTED <- TRUE
 ...
 if(LABEL_DETECTED == TRUE) {
	...
	if(grepl("0", thisTitle)) { # this line will change for each different dataset
	      label_list[[i]] <-  0
	 } else if(grepl("1", thisTitle)) { # this line will change for each different dataset
	    label_list[[i]] <- 1
	  }
	  else {
             label_list[[i]] <- -1
