...
GSE_code <- "GSE19234" # this line will change for each different dataset
thisGEOplatform <- "GPL570" # this line will change for each different dataset
datasetName <-  "Bogunovic2009" # this line will change for each different dataset
cancer_type <- "skin_cancer" # this line will change for each different dataset
